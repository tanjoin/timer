export class SoundModel {
    ...
    public play() {
        ...
        audio.src = `data:audio/wav;base64,${SoundModel._SOUND_BASE64}`;
        audio.play();
    }

    public playSilent() {
        const audio = new Audio();
        audio.src = `data:audio/wav;base64,${SoundModel._SILENT_SOUND_BASE64}`;
        audio.play();
    }

    private static _SOUND_BASE64 = `SUQzBAAAAAAAfFRYWFgAAAASAAADbWFqb3JfYnJhbmQAcXQgIABUWFhYAAAAEQAAA21pbm
...
VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVU=`;
    private static _SILENT_SOUND_BASE64 = `SUQzBAAAAAAAIlRTU0UAAAAOAAADTGF2ZjYxLjEuMTAwAAAAAAAAAAAAAAD/+0DA
